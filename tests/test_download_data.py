...
@pytest.mark.parametrize("target_path", ["/home/runner/work/example-project/example-project/examples/data",
                                         "/home/runner/work/example-project/example-project/tests"])
